...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject barteringScreen;
    [SerializeField] private SpriteRenderer mouseFeedbackSquare;
    [SerializeField] private GameObject pitPrefab, cornCropPrefab;
